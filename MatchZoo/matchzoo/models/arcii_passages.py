...
class ARCII(BasicModel):
    def __init__(self, config):
        ...
        self.check_list = ['text1_maxlen', 'text2_maxlen', 'embed', 'embed_size', 'vocab_size', 'text1_attention',
                           'text2_attention', '1d_kernel_size', '1d_kernel_count', 'num_conv2d_layers',
                           '2d_kernel_sizes', '2d_kernel_counts', '2d_mpool_sizes', 'dropout_rate', "context_len",
                           "context_num", "passage_attention"]
